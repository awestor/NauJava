...
public class MealResponse {
    ...
    public List<MealEntryResponse> getMealEntries() { return mealEntries; }
    public void setMealEntries(List<MealEntryResponse> mealEntries) { this.mealEntries = mealEntries; }
}
